...
-- Description:	Returns all system objects across all 
--				user-created databases (database ID > 4) 
--				whose names contain the specified 
--				search expression. The search is 
--				case insensitive.
-- =============================================
CREATE OR ALTER PROCEDURE [dbo].[uspGetSystemObjectsBySearchExpression] 
(
...
-- dbo.uspGetSystemObjectsBySearchExpression
-- =============================================

-- Description for stored procedure
EXEC [sys].[sp_addextendedproperty]
	 @name = N'MS_Description',
	 @value = N'Returns all system objects across all user-created databases (database ID > 4) whose names contain the specified search expression. The search is case insensitive.',
	 @level0type = N'SCHEMA', @level0name = N'dbo',
	 @level1type = N'PROCEDURE', @level1name = N'uspGetSystemObjectsBySearchExpression';
GO
