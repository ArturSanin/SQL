/*
	==================== Description ====================
	This query creates a view that contains data type 
...
CREATE VIEW [DbInfo].[vColumnDataTypes]
AS
SELECT
...
-- =================================================
-- MS_Description for the view vColumnDataTypes.
-- =================================================

-- View description.
EXEC [sys].[sp_addextendedproperty] 
	@name = N'MS_Description', 
	@value = N'View contains data type information for columns in user-defined tables and views. It provides an overview of the data types used and can be used to identify opportunities for data type optimization and standardization.', 
	@level0type = N'SCHEMA', @level0name = N'DbInfo', 
	@level1type = N'VIEW', @level1name = N'vColumnDataTypes';
	GO
