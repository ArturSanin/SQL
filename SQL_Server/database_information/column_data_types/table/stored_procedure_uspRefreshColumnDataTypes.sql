...
-- Description:	This stored procedure updates the table DbInfo.ColumnDataTypes 
--				with the current data type information for columns in user-defined tables and views.
-- =============================================
CREATE PROCEDURE [DbInfo].[uspRefreshColumnDataTypes] 
AS
BEGIN

	SET NOCOUNT ON;

    TRUNCATE TABLE [DbInfo].[ColumnDataTypes];
...
-- =================================================================
-- MS_Description for the stored procedure uspRefreshColumnDataTypes
-- =================================================================

-- Stored procedure description.
EXEC [sys].[sp_addextendedproperty]
    @name = N'MS_Description',
    @value = N'This stored procedure updates the table DbInfo.ColumnDataTypes with the current data type information for columns in user-defined tables and views.',
    @level0type = N'SCHEMA', @level0name = N'DbInfo',
    @level1type = N'PROCEDURE', @level1name = N'uspRefreshColumnDataTypes';
GO