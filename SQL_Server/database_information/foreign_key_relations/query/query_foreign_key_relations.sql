/*
	============================== Description ==============================
	This query returns the relationships between foreign key constraints and 
	the primary key or unique key constraints they reference. Each row 
	represents one foreign key definition, including the table where it is 
