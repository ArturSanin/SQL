/*
	============================== Description ==============================
	This query creates a view, that contains the relationships between foreign 
...
CREATE VIEW [DbInfo].[vForeignKeyRelations] 
AS
...
-- =================================================
-- MS_Description for the view vForeignKeyRelations.
-- =================================================

-- Table description.
EXEC [sys].[sp_addextendedproperty] 
    @name = N'MS_Description', 
    @value = N'View that stores the relationships between foreign key constraints and the primary key or unique key constraints they reference. Each row represents one foreign key definition, including the table where it is defined and the table and key it points to.',
    @level0type = N'SCHEMA', @level0name = N'DbInfo',
    @level1type = N'VIEW',  @level1name = N'vForeignKeyRelations';
GO
