/*
	============================== Description ==============================
	This query creates a view that returns all primary keys in the database 
...
CREATE VIEW [DbInfo].[vPrimaryKeysWithoutForeignKeyReferences]
AS
-- =====================================================================
...
-- ===================================================================
-- MS_Description for the view vPrimaryKeysWithoutForeignKeyReferences.
-- ===================================================================

-- Table description.
EXEC [sys].[sp_addextendedproperty] 
    @name = N'MS_Description', 
    @value = N'View containing all primary keys in the database that are not referenced by any foreign key.', 
    @level0type = N'SCHEMA', @level0name = N'DbInfo',
    @level1type = N'VIEW',  @level1name = N'vPrimaryKeysWithoutForeignKeyReferences';
GO
