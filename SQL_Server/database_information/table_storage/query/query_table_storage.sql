/*
	============================== Description ==============================
	This query provides an overview of each table’s structure and storage usage, 
    including the number of columns, row count, and the amount of reserved, used, 
    unused, data, and index space.
*/
