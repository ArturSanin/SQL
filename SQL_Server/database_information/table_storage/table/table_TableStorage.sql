/*
	============================== Description ==============================
	This query creates a table, that provides an overview of each table’s structure 
...
-- =================================================
-- MS_Description for the table TableStorage.
-- =================================================

-- Table description.
EXEC [sys].[sp_addextendedproperty]
    @name = N'MS_Description',
    @value = N'This table provides an overview of each table''s structure and storage usage, including column count, row count, and reserved, used, unused, data, and index space.',
    @level0type = N'SCHEMA', @level0name = N'DbInfo',
    @level1type = N'TABLE',  @level1name = N'TableStorage';
GO
