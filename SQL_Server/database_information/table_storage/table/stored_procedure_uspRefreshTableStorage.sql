...
-- =============================================
CREATE PROCEDURE [DbInfo].[uspRefreshTableStorage] 
AS
BEGIN
...
-- ==============================================================
-- MS_Description for the stored procedure uspRefreshTableStorage
-- ==============================================================
...
EXEC [sys].[sp_addextendedproperty]
    ...
    @level1type = N'PROCEDURE', @level1name = N'uspRefreshTableStorage';
GO