...
-- Description:	Returns all columns of system 
--				objects in the [sys] and 
--				[INFORMATION_SCHEMA] schemas whose 
--				names contain the specified search 
--				expression.
-- =============================================
CREATE OR ALTER FUNCTION [DbInfo].[ufnGetSysColumnsBySearchExpression]
(	
...
-- =============================================
-- MS_Description for function and its parameters: DbInfo.ufnGetSysColumnsBySearchExpression
-- =============================================

-- Description for function
EXEC [sys].[sp_addextendedproperty]
	 @name = N'MS_Description',
	 @value = N'Returns all columns of system objects in the [sys] and [INFORMATION_SCHEMA] schemas whose names contain the specified search expression.',
	 @level0type = N'SCHEMA', @level0name = N'DbInfo',
	 @level1type = N'FUNCTION', @level1name = N'ufnGetSysColumnsBySearchExpression';
GO
