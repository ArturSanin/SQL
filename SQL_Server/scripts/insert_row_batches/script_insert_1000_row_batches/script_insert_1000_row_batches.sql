...
/*
	...
	into a target table. The target table must already exist, and the column order must 
	match the source table before executing the generated script. This script is intended for 
